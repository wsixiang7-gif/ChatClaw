export default {
  ...
  knowledge: {
    help: {
      ...
      semanticSegmentation: 'When enabled, uses embedding model to intelligently segment by semantic boundaries, improving chunking quality.',
      raptorLLMModel: 'Language model for generating RAPTOR multi-level summaries (optional). Builds a hierarchical summary tree to improve retrieval.',
    },
    tabs: {
      personal: 'Personal',
      team: 'Team',
    ...
    create: {
      ...
      raptorLLMModel: 'RAPTOR Summary Model',
      noRaptorLLM: 'No RAPTOR',
