export default {
  ...
  knowledge: {
    help: {
      ...
      semanticSegmentation: '启用后，将使用嵌入模型按语义边界进行智能分段，提高分段质量。',
      raptorLLMModel: '用于生成 RAPTOR 多层摘要的语言模型（可选）。启用后将构建层级摘要树以提升检索效果。',
    },
    tabs: {
      personal: '个人',
      team: '团队',
    ...
    create: {
      ...
      raptorLLMModel: 'RAPTOR 摘要模型',
      noRaptorLLM: '不使用 RAPTOR',
      chunkSize: '分片大小',
      chunkOverlap: '重叠大小',
